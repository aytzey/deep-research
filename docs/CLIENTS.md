...
| --- | --- | --- | --- |
| Claude Desktop | long-form research and synthesis | JSON | `uv run zotero-researcher-mcp` |
| Codex | tool-driven iteration and repo work | TOML | `uv run zotero-researcher-mcp` |
